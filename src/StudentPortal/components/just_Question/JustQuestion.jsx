...
import "./JustQuestion.scss"

import pre from "../../assets/icons/pre.svg"
import next from "../../assets/icons/next.svg"
// import vol from "../../assets/icons/vol.png"
...
const JustQuestion = () => {
    return (
        <>
     <div className="jq__container">
           <div className="header">
               <div className="left">Question 7 Out of 80</div>
               <div className="left">1.1.203-102/Basic Knoledge</div>
               <div className="left">
                   <div className="text">Points 5</div>
                   {/* <img src={vol} alt="" className="header__icon" /> */}
